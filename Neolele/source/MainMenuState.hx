	...
	override function create()
	{
		...
		if (!FlxG.sound.music.playing)
		{
			if (StoryMenuState.weekUnlocked[1])
				FlxG.sound.playMusic(Paths.music('drawing'));
		...
		//var notetext:FlxText = new FlxText(250, 100, 0, 'press A to view achievements, and C for something sus!', 20, false);
		//notetext.setFormat(null, 20, FlxColor.BLACK);
		//add(notetext);
